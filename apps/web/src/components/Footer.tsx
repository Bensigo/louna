        ...
        <Flex justify="space-between" align="center" flexWrap="wrap">
          <Box mb={{ base: 4, md: 0 }}>
            <Link href="/" onClick={handleLogoClick}>
              <Image src="/solu.png" alt="Your Logo" width={100} />
            </Link>
          </Box>
          {isLaptopView && (
          ...
          >
            <Stack>
              <Flex justify="center" mb={{ base: 4, md: 0 }}>
                <Link href="#" mr={4} aria-label="Instagram" title="Instagram">
                  <FaInstagram color="#f4e5ce" size={24} />
                </Link>
                <Link href="#" mr={4} aria-label="TikTok" title="TikTok">
                  <FaTiktok color="#f4e5ce" size={24} />
                </Link>
                <Link href="#" aria-label="LinkedIn" title="LinkedIn">
