...
const communityImg = require('../../../assets/cooking.jpg')


const OnboardingRecipeWelcomeScreen = () => {
     const { replace } = useRouter()
    const { width: SCREEN_WIDTH, height: SCREEN_HEIGHT } = useWindowDimensions();
  const handlePress = () => {
  // go to oboarding questions
     replace('/(onboarding)/questionSix')
  ...
  return (
    <View  flex={1} style={{ width: SCREEN_WIDTH}}  bg={"#f5e6cf"}>
      ...
      <View paddingHorizontal="$4" paddingTop={4}  alignItems="center" >
          <H4 color="black" fontWeight={"$7"}>Personalize your diet</H4>
...
export default OnboardingRecipeWelcomeScreen;