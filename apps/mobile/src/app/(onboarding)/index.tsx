...
const communityImg = require('../../../assets/community.jpg')
...
const OnboardingWelcomeScreen = () => {
  ...
  // go to oboarding questions
     replace('/(onboarding)/questionOne')
  ...
  return (
    <View  flex={1} style={{ width: SCREEN_WIDTH}}  bg={"#f5e6cf"}>
      ...
      <View paddingHorizontal="$4" paddingTop={4}  alignItems="center" >
          <H4 color="black" fontWeight={"$7"}>Welcome To The Solu Family</H4>
