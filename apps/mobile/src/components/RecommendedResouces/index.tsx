...
type Resource = NonNullable<RouterOutputs["resource"]["list"][0]>
        ...
        <View borderWidth="$0" mr={"$3"} py={"$1"} {...rest}>
                ...
                <TouchableOpacity onPress={handlePress}>
                    ...
                    <View py={"$4"}>
                       ...
                       <View mt="$2"  borderRadius={10} bg={Colors.light.secondray} py={'$1'} px="$2" maxWidth={70}>
                            <Text textAlign="center"  fontSize={'$3'} color={Colors.light.primary}>{resource.contentType === 'Link' ? 'Article': resource.contentType  }</Text>
                       </View>
                    </View>
                </TouchableOpacity>
